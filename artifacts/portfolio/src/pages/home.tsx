          ...
          >
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <img src="/intellia-logo.png" alt="Intellia" className="h-16 w-auto" style={{ filter: "brightness(0) saturate(100%)" }} data-testid="img-intellia-logo-hero" />
              </div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="space-y-3 mb-16">
          <div className="flex items-center gap-3">
            ...
            <img src="/intellia-logo.png" alt="Intellia" className="h-14 w-auto" style={{ filter: "brightness(0) saturate(100%)" }} data-testid="img-intellia-logo-consulting" />
          </div>
        ...
        <div className="md:text-right md:pr-12">
          ...
          {logoSrc ? (
            <div className="flex items-center gap-2 md:justify-end mt-1">
              <img src={logoSrc} alt={company} className="h-14 w-auto" style={{ filter: "brightness(0) saturate(100%)" }} data-testid="img-intellia-logo-experience" />
            </div>
          ) : (
